...
const MovieNavbar = () => {
  return (
    <>
      <nav className="absolute inset-x-0 bg-opacity-10 backdrop-filter backdrop-blur-lg lg:relative z-30 lg:bg-bms-700 p-4">
        <div className="md:hidden">{/*Mobile screen*/}
          <NavSm /></div>
        <div className="hidden md:flex lg:hidden">{/*Median screen*/}
          <NavSm />
        </div>
